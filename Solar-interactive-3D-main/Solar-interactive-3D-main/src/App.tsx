  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      if (closestPlanetName) {
        ...
        targetBracketMat.opacity = THREE.MathUtils.lerp(targetBracketMat.opacity, 0.4 + hoverLockRef.current * 0.4, 0.1);
      } else {
        targetBracketMat.opacity = THREE.MathUtils.lerp(targetBracketMat.opacity, 0, 0.1);
      }
